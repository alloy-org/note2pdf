const plugin = {
  ...
  async _htmlToCanvas(html) {
    const canvas = await html2canvas(html, {
      ignoreElements: node => {
        // Not working, but inspired by https://github.com/niklasvh/html2canvas/issues/1859
        return node.style['background-image'].indexOf('image/svg') !== -1;;
      },
      proxy: "https://amplenote-readwise-cors-anywhere.onrender.com/",
      useCORS: true,
    });
    ...
    console.log("Image drawn off-canvas")
